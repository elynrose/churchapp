...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Apps
    Route::delete('apps/destroy', 'AppController@massDestroy')->name('apps.massDestroy');
    ...
    // Page Layouts
    Route::delete('page-layouts/destroy', 'PageLayoutController@massDestroy')->name('page-layouts.massDestroy');
    Route::resource('page-layouts', 'PageLayoutController');
