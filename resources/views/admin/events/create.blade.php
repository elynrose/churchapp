    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('event_date') ? 'is-invalid' : '' }}" type="text" name="event_date" id="event_date" value="{{ old('event_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_address') ? 'is-invalid' : '' }}" type="text" name="event_address" id="event_address" value="{{ old('event_address', '') }}">
