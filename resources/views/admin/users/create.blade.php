    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('church') ? 'is-invalid' : '' }}" type="text" name="church" id="church" value="{{ old('church', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pastor_name') ? 'is-invalid' : '' }}" type="text" name="pastor_name" id="pastor_name" value="{{ old('pastor_name', '') }}" required>
