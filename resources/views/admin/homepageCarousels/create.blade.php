...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.homepage-carousels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('primary') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="primary" id="primary" value="1" {{ old('primary', 0) == 1 ? 'checked' : '' }}>
