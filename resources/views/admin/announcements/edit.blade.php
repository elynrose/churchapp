    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.announcements.update", [$announcement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('expires_on') ? 'is-invalid' : '' }}" type="text" name="expires_on" id="expires_on" value="{{ old('expires_on', $announcement->expires_on) }}" required>
