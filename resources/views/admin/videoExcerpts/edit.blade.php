...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.videoExcerpt.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.video-excerpts.update", [$videoExcerpt->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.videoExcerpt.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $videoExcerpt->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preached_by') ? 'is-invalid' : '' }}" type="text" name="preached_by" id="preached_by" value="{{ old('preached_by', $videoExcerpt->preached_by) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_preached') ? 'is-invalid' : '' }}" type="text" name="date_preached" id="date_preached" value="{{ old('date_preached', $videoExcerpt->date_preached) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $videoExcerpt->location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ordering') ? 'is-invalid' : '' }}" type="number" name="ordering" id="ordering" value="{{ old('ordering', $videoExcerpt->ordering) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $videoExcerpt->active || old('active', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="active">{{ trans('cruds.videoExcerpt.fields.active') }}</label>
                </div>
...
<script>
    ...
    url: '{{ route('admin.video-excerpts.storeMedia') }}',
    maxFilesize: 400, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
