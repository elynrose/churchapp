                ...
                <tbody>
                    @foreach($directories as $key => $directory)
                        <tr data-entry-id="{{ $directory->id }}">
                            ...
                            <td>
                                @can('directory_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.directories.show', $directory->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('directory_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.directories.edit', $directory->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('directory_delete')
                                    <form action="{{ route('admin.directories.destroy', $directory->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
