...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.weeks-messages.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="week_of">{{ trans('cruds.weeksMessage.fields.week_of') }}</label>
                <input class="form-control date {{ $errors->has('week_of') ? 'is-invalid' : '' }}" type="text" name="week_of" id="week_of" value="{{ old('week_of') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('message_titles') ? 'is-invalid' : '' }}" name="message_titles" id="message_titles" required>{{ old('message_titles') }}</textarea>
