        ...
        <form method="POST" action="{{ route("admin.modules.update", [$module->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ $module->published || old('published', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="published">{{ trans('cruds.module.fields.published') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.module.fields.published_helper') }}</span>
            </div>
            <div class="form-group">
