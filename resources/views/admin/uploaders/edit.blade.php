...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.uploader.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.uploaders.update", [$uploader->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.uploader.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $uploader->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_preached') ? 'is-invalid' : '' }}" type="text" name="date_preached" id="date_preached" value="{{ old('date_preached', $uploader->date_preached) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preached_by') ? 'is-invalid' : '' }}" type="text" name="preached_by" id="preached_by" value="{{ old('preached_by', $uploader->preached_by) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $uploader->location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_code') ? 'is-invalid' : '' }}" type="text" name="file_code" id="file_code" value="{{ old('file_code', $uploader->file_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coconut_job_code') ? 'is-invalid' : '' }}" type="text" name="coconut_job_code" id="coconut_job_code" value="{{ old('coconut_job_code', $uploader->coconut_job_code) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('processed') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="processed" id="processed" value="1" {{ $uploader->processed || old('processed', 0) === 1 ? 'checked' : '' }}>
