...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qotds.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('quote') ? 'is-invalid' : '' }}" name="quote" id="quote">{{ old('quote') }}</textarea>
                @if($errors->has('quote'))
                    <div class="invalid-feedback">
                        {{ $errors->first('quote') }}
                    </div>
