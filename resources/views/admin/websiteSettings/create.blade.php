    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.website-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_content') ? 'is-invalid' : '' }}" name="meta_content" id="meta_content">{{ old('meta_content') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords') ? 'is-invalid' : '' }}" name="keywords" id="keywords">{{ old('keywords') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('global_css') ? 'is-invalid' : '' }}" name="global_css" id="global_css">{{ old('global_css') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('global_js') ? 'is-invalid' : '' }}" name="global_js" id="global_js">{{ old('global_js') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('maintainance_mode') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="maintainance_mode" id="maintainance_mode" value="1" {{ old('maintainance_mode', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('maintainance_message') ? 'is-invalid' : '' }}" name="maintainance_message" id="maintainance_message">{{ old('maintainance_message') }}</textarea>
