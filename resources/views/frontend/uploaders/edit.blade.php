    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.uploaders.update", [$uploader->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.uploader.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $uploader->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_preached" id="date_preached" value="{{ old('date_preached', $uploader->date_preached) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="preached_by" id="preached_by" value="{{ old('preached_by', $uploader->preached_by) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $uploader->location) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="file_code" id="file_code" value="{{ old('file_code', $uploader->file_code) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="coconut_job_code" id="coconut_job_code" value="{{ old('coconut_job_code', $uploader->coconut_job_code) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="processed" id="processed" value="1" {{ $uploader->processed || old('processed', 0) === 1 ? 'checked' : '' }}>
