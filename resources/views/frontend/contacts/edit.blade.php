                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="full_name" id="full_name" value="{{ old('full_name', $contact->full_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="church" id="church" value="{{ old('church', $contact->church) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category" id="category" required>
                                ...
                                @foreach(App\Models\Contact::CATEGORY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('category', $contact->category) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" id="comment" required>{{ old('comment', $contact->comment) }}</textarea>
