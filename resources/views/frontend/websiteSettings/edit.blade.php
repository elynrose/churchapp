    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.website-settings.update", [$websiteSetting->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="site_name">{{ trans('cruds.websiteSetting.fields.site_name') }}</label>
                            <input class="form-control" type="text" name="site_name" id="site_name" value="{{ old('site_name', $websiteSetting->site_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_content" id="meta_content">{{ old('meta_content', $websiteSetting->meta_content) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keywords" id="keywords">{{ old('keywords', $websiteSetting->keywords) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="global_css" id="global_css">{{ old('global_css', $websiteSetting->global_css) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="global_js" id="global_js">{{ old('global_js', $websiteSetting->global_js) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="maintainance_mode" id="maintainance_mode" value="1" {{ $websiteSetting->maintainance_mode || old('maintainance_mode', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="maintainance_message" id="maintainance_message">{{ old('maintainance_message', $websiteSetting->maintainance_message) }}</textarea>
