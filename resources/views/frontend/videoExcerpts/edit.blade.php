    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.video-excerpts.update", [$videoExcerpt->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.videoExcerpt.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $videoExcerpt->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="preached_by" id="preached_by" value="{{ old('preached_by', $videoExcerpt->preached_by) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_preached" id="date_preached" value="{{ old('date_preached', $videoExcerpt->date_preached) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $videoExcerpt->location) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ordering" id="ordering" value="{{ old('ordering', $videoExcerpt->ordering) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $videoExcerpt->active || old('active', 0) === 1 ? 'checked' : '' }}>
