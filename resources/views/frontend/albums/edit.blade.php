    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.albums.update", [$album->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.album.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $album->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $album->active || old('active', 0) === 1 ? 'checked' : '' }}>
                                <label for="active">{{ trans('cruds.album.fields.active') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="cover_photo-dropzone">
                            </div>
