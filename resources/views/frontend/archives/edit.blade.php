    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.archives.update", [$archive->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.archive.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $archive->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $archive->location) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $archive->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_preached" id="date_preached" value="{{ old('date_preached', $archive->date_preached) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $archive->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="video_url" id="video_url" value="{{ old('video_url', $archive->video_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="audio_url" id="audio_url" value="{{ old('audio_url', $archive->audio_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pdf_file" id="pdf_file" value="{{ old('pdf_file', $archive->pdf_file) }}">
