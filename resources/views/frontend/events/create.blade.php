                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.events.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="event_date" id="event_date" value="{{ old('event_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="event_time" id="event_time" value="{{ old('event_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_address" id="event_address" value="{{ old('event_address', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="app_id" id="app_id" required>
                                @foreach($apps as $id => $app)
                                    <option value="{{ $id }}" {{ old('app_id') == $id ? 'selected' : '' }}>{{ $app }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('app'))
                                <div class="invalid-feedback">
