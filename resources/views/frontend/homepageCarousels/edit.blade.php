    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.homepage-carousels.update", [$homepageCarousel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="headline" id="headline" value="{{ old('headline', $homepageCarousel->headline) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_heading" id="sub_heading" value="{{ old('sub_heading', $homepageCarousel->sub_heading) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link_to" id="link_to" value="{{ old('link_to', $homepageCarousel->link_to) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="order" id="order" value="{{ old('order', $homepageCarousel->order) }}" step="1" required>
                            @if($errors->has('order'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('order') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="primary" id="primary" value="1" {{ $homepageCarousel->primary || old('primary', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $homepageCarousel->active || old('active', 0) === 1 ? 'checked' : '' }}>
