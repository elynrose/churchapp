    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.weeks-messages.update", [$weeksMessage->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="week_of">{{ trans('cruds.weeksMessage.fields.week_of') }}</label>
                            <input class="form-control date" type="text" name="week_of" id="week_of" value="{{ old('week_of', $weeksMessage->week_of) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="message_titles" id="message_titles" required>{{ old('message_titles', $weeksMessage->message_titles) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $weeksMessage->active || old('active', 0) === 1 ? 'checked' : '' }}>
