...
class WebsiteSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.websiteSettings.index', compact('websiteSettings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.websiteSettings.create');
    }
    ...
    public function store(StoreWebsiteSettingRequest $request)
    {
        ...
        return redirect()->route('frontend.website-settings.index');
    }
    ...
    public function edit(WebsiteSetting $websiteSetting)
    {
        ...
        return view('frontend.websiteSettings.edit', compact('websiteSetting'));
    }
    ...
    public function show(WebsiteSetting $websiteSetting)
    {
        ...
        return view('frontend.websiteSettings.show', compact('websiteSetting'));
    }
