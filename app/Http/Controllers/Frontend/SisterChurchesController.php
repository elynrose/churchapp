...
class SisterChurchesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.sisterChurches.index', compact('sisterChurches'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sisterChurches.create');
    }
    ...
    public function store(StoreSisterChurchRequest $request)
    {
        ...
        return redirect()->route('frontend.sister-churches.index');
    }
    ...
    public function edit(SisterChurch $sisterChurch)
    {
        ...
        return view('frontend.sisterChurches.edit', compact('sisterChurch'));
    }
    ...
    public function show(SisterChurch $sisterChurch)
    {
        ...
        return view('frontend.sisterChurches.show', compact('sisterChurch'));
    }
