...
class VideoExcerptsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.videoExcerpts.index', compact('videoExcerpts'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.videoExcerpts.create');
    }
    ...
    public function store(StoreVideoExcerptRequest $request)
    {
        ...
        return redirect()->route('frontend.video-excerpts.index');
    }
    ...
    public function edit(VideoExcerpt $videoExcerpt)
    {
        ...
        return view('frontend.videoExcerpts.edit', compact('videoExcerpt'));
    }
    ...
    public function show(VideoExcerpt $videoExcerpt)
    {
        ...
        return view('frontend.videoExcerpts.show', compact('videoExcerpt'));
    }
