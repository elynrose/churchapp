...
class HomepageCarouselController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.homepageCarousels.index', compact('homepageCarousels'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.homepageCarousels.create');
    }
    ...
    public function store(StoreHomepageCarouselRequest $request)
    {
        ...
        return redirect()->route('admin.homepage-carousels.index');
    }
    ...
    public function edit(HomepageCarousel $homepageCarousel)
    {
        ...
        return view('admin.homepageCarousels.edit', compact('homepageCarousel'));
    }
    ...
    public function show(HomepageCarousel $homepageCarousel)
    {
        ...
        return view('admin.homepageCarousels.show', compact('homepageCarousel'));
    }
