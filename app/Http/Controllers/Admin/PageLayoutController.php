...
class PageLayoutController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pageLayouts.index', compact('pageLayouts'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.pageLayouts.create', compact('pages', 'modules'));
    }
    ...
    public function store(StorePageLayoutRequest $request)
    {
        ...
        return redirect()->route('admin.page-layouts.index');
    }
    ...
    public function edit(PageLayout $pageLayout)
    {
        ...
        return view('admin.pageLayouts.edit', compact('pages', 'modules', 'pageLayout'));
    }
    ...
    public function show(PageLayout $pageLayout)
    {
        ...
        return view('admin.pageLayouts.show', compact('pageLayout'));
    }
