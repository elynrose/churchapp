...
class PraiseprayerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.praiseprayers.index', compact('praiseprayers'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.praiseprayers.create');
    }
    ...
    public function store(StorePraiseprayerRequest $request)
    {
        ...
        return redirect()->route('admin.praiseprayers.index');
    }
    ...
    public function edit(Praiseprayer $praiseprayer)
    {
        ...
        return view('admin.praiseprayers.edit', compact('praiseprayer'));
    }
    ...
    public function show(Praiseprayer $praiseprayer)
    {
        ...
        return view('admin.praiseprayers.show', compact('praiseprayer'));
    }
