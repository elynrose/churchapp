...
class QotdController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.qotds.index', compact('qotds'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.qotds.create');
    }
    ...
    public function store(StoreQotdRequest $request)
    {
        ...
        return redirect()->route('admin.qotds.index');
    }
    ...
    public function edit(Qotd $qotd)
    {
        ...
        return view('admin.qotds.edit', compact('qotd'));
    }
    ...
    public function show(Qotd $qotd)
    {
        ...
        return view('admin.qotds.show', compact('qotd'));
    }
