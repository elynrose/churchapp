...
class WeeksMessagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.weeksMessages.index', compact('weeksMessages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.weeksMessages.create');
    }
    ...
    public function store(StoreWeeksMessageRequest $request)
    {
        ...
        return redirect()->route('admin.weeks-messages.index');
    }
    ...
    public function edit(WeeksMessage $weeksMessage)
    {
        ...
        return view('admin.weeksMessages.edit', compact('weeksMessage'));
    }
    ...
    public function show(WeeksMessage $weeksMessage)
    {
        ...
        return view('admin.weeksMessages.show', compact('weeksMessage'));
    }
